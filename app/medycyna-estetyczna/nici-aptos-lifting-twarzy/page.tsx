...
import { NiciAptosArticle } from "@/components/sections/NiciAptosArticle";
...
export const metadata: Metadata = {
  title: "Nici Aptos — lifting twarzy bez skalpela — ClinicaNova Gdańsk",
  description:
    "Nici Aptos w ClinicaNova: lifting twarzy i ciała bez operacji, naturalne efekty, minimalna rekonwalescencja. Konsultacja w Gdańsku.",
};

export default function NiciAptosLiftingTwarzyPage() {
  return (
    <>
      <Header />
      <main>
        <section
          ...
          aria-labelledby="nici-aptos-hero-heading"
        >
        ...
        <MedycynaEstetycznaSubpageCta headingId="nici-aptos-cta-heading" />
      </main>
      <Footer />
    </>
  );
