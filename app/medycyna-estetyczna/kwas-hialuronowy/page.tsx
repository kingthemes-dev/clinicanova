...
import { KwasHialuronowyArticle } from "@/components/sections/KwasHialuronowyArticle";
...
export const metadata: Metadata = {
  title: "Kwas hialuronowy — ClinicaNova Gdańsk",
  description:
    "Kwas hialuronowy w ClinicaNova: wolumetria, modelowanie ust, korekta nosa, nawilżenie. Konsultacja i zabiegi w Gdańsku.",
};

export default function KwasHialuronowyPage() {
  return (
    <>
      <Header />
      <main>
        <section
          ...
          aria-labelledby="kwas-hialuronowy-hero-heading"
        >
          <div className={subpageHeroMediaShellClass}>
            ...
            <Container className={subpageHeroContainerClass}>
              <h1
                id="kwas-hialuronowy-hero-heading"
        ...
        <SubpageMainSection>
          ...
          <KwasHialuronowyArticle />
        </SubpageMainSection>

        <MedycynaEstetycznaSubpageCta headingId="kwas-hialuronowy-cta-heading" />
      </main>
      <Footer />
    </>
  );
