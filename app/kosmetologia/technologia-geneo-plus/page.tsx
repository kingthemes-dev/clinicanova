...
import { TechnologiaGeneoPlusArticle } from "@/components/sections/TechnologiaGeneoPlusArticle";
...
const BREADCRUMBS = [
  ...
  { label: "Technologia GENEO+" },
] as const;

export const metadata: Metadata = {
  title: "Technologia GENEO+ — ClinicaNova Gdańsk",
  description:
    "Geneo+ w ClinicaNova: Oxygeneo, Tripollar RF, Ultrasound — oczyszczenie, dotlenienie, lifting. Twarz, szyja, dekolt.",
};

export default function TechnologiaGeneoPlusPage() {
  return (
    <>
      <Header />
      <main>
        <section
          ...
          aria-labelledby="geneo-hero-heading"
        >
        ...
        <SubpageMainSection>
          ...
          <TechnologiaGeneoPlusArticle />
        </SubpageMainSection>

        <MedycynaEstetycznaSubpageCta headingId="geneo-cta-heading" />
      </main>
      <Footer />
    </>
  );
