...
import { Dermapen4Article } from "@/components/sections/Dermapen4Article";
...
export const metadata: Metadata = {
  title: "DERMAPEN 4 — ClinicaNova Gdańsk",
  description:
    "Dermapen 4 w ClinicaNova: mikroigły, blizny, rozstępy, odmładzanie skóry twarzy i ciała. Gdańsk.",
};

export default function Dermapen4Page() {
  return (
    <>
      <Header />
      <main>
        <section
          ...
          aria-labelledby="dermapen-hero-heading"
        >
        ...
        <MedycynaEstetycznaSubpageCta headingId="dermapen-cta-heading" />
      </main>
      <Footer />
    </>
  );
