...
import { CENNIK_KOSMETOLOGIA_SECTIONS } from "@/lib/cennikKosmetologiaPriceList";
import {
...
export const metadata: Metadata = {
  title: "Cennik — kosmetologia — ClinicaNova Gdańsk",
  description:
    "Ceny zabiegów kosmetologicznych: peelingi, Dermapen, Geneo+, lasery, epilacja Primelase i więcej — ClinicaNova Gdańsk.",
};

export default function CennikKosmetologiaPage() {
  return (
    <>
      <Header />
      <main>
        <section
          ...
          aria-labelledby="cennik-kosmetologia-hero-heading"
        >
          <div className={subpageHeroMediaShellClass}>
            ...
            <Container className={subpageHeroContainerClass}>
              ...
              <h1
                id="cennik-kosmetologia-hero-heading"
        ...
        <SubpageMainSection aria-labelledby="cennik-kosmetologia-intro-heading">
          <div className={subpageBreadcrumbsMarginClass}>
            <Breadcrumbs items={[...BREADCRUMBS]} />
          </div>
          <div className="w-full">
            <h2
              id="cennik-kosmetologia-intro-heading"
            ...
            <p className={`mt-5 max-w-3xl ${bodyProseClass}`}>
              Poniżej orientacyjne ceny zabiegów kosmetologicznych. Ostateczny
              koszt ustalany jest indywidualnie po konsultacji.{" "}
              <Link
                href="/kosmetologia"
          ...
          <div className="mt-12 sm:mt-14 lg:mt-16">
            <CennikRichPriceTables sections={CENNIK_KOSMETOLOGIA_SECTIONS} />
          </div>
        </SubpageMainSection>

        <MedycynaEstetycznaSubpageCta headingId="cennik-kosmetologia-cta-heading" />
      </main>
      <Footer />
    </>
  );
